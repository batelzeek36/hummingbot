...
### Phase 5: Hyperliquid Monster Bot v2.2 (Current)
- **Key Upgrades**:
...
- **Bot File**: `scripts/strategies/hyperliquid_monster_bot_v2.py`
- **Status**: Production ready

## Current Strategy (v2.2)

| Strategy | Pair | Leverage | Capital | Target |
|----------|------|----------|---------|--------|
| Funding | 14 pairs (smart) | 2-8x | 45% ($35) | Capture high APRs |
...
scripts/
├── strategies/
│   ├── hyperliquid_monster_bot_v2.py  # Current production bot
│   └── hyperliquid_monster_bot.py     # V1 (deprecated)
├── analytics/
...
└── HANDOFF_OPTIMIZATION_TODO.md       # Optimization tracking
```
